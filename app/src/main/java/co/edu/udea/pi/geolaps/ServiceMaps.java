...
import co.edu.udea.pi.geolaps.database.DBUtil;
import co.edu.udea.pi.geolaps.database.GeoLapsContract;
...
public class ServiceMaps extends Service implements
    ...
    public final static String BR = "co.edu.udea.pi.geolaps";
